...
function selectAnswer(e) {
  ...
  Array.from(answerButtonElement.children).forEach((button) => {
    ...
    if (shuffledQuestions.length > currentQuestionIndex + 1) {
      ...
      //Needs to a submit timer when clicked
...
/* 
Answer is showing wrong text when clicked
...
Once submit is clicked, prompt local storage key for name, and have timer be value 
*/


//LocalStorage

const inputValue = document.querySelector("#inputKey");
